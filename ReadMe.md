...
10.Case Statements
	...
	10.2 Show Department Category(Using Case with Join)

		SQL Query:SELECT e.EmpName,
       				 d.DeptName,
			         CASE WHEN d.DeptName = 'HR' THEN 'Human Resources'
...
11.Output Documentation: 1.Query results are saved in Output.md file			
